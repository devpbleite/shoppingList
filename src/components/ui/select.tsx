...
const SelectContent = ({ className, children, position = 'popper', container, ...props }: React.ComponentPropsWithoutRef<typeof SelectPrimitive.Content> & { container?: HTMLElement }) => {
...
export {
  SelectWithError, // exportando o componente corrigido
  SelectGroup,
  SelectValue,
  SelectTrigger,
  SelectContent,
